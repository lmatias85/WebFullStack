...
var Juego = {
  ...
  obstaculosCarretera: [
    new Obstaculo('imagenes/valla_horizontal.png', 70, 80, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 180, 130, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 100, 200, 15, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 70, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 130, 430, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 400, 400, 30, 15, 1),
    new Obstaculo('imagenes/bache.png', 450, 300, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 750, 130, 30, 30, 0.5),
    new Obstaculo('imagenes/auto_verde_abajo.png', 850, 270, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 780, 400, 30, 15, 1)
  ],
  bordes: [
    // // Bordes
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 930, 100, 10, 10, 0.5, {desdeX: 20, hastaX: 930, desdeY: 10, hastaY: 560}),
    new ZombieCaminante('imagenes/zombie2.png', 930, 100, 10, 10, 1, {desdeX: 20, hastaX: 930, desdeY: 10, hastaY: 560}),
    new ZombieCaminante('imagenes/zombie2.png', 930, 300, 10, 10, 1, {desdeX: 20, hastaX: 930, desdeY: 10, hastaY: 560}),
    new ZombieCaminante('imagenes/zombie4.png', 930, 400, 10, 10, 2, {desdeX: 20, hastaX: 930, desdeY: 10, hastaY: 560}),
    new ZombieConductor('imagenes/tren_horizontal.png', 20, 322, 90, 30, 4, {desdeX: 0, hastaX: 960, desdeY: 322, hastaY: 322},'h'),
    new ZombieConductor('imagenes/tren_vertical.png', 644, 0, 30, 90, 4, {desdeX: 644, hastaX: 644, desdeY: 0, hastaY: 600},'v'),
    new ZombieConductor('imagenes/tren_vertical.png', 678, 0, 30, 90, 2.5, {desdeX: 678, hastaX: 678, desdeY: 0, hastaY: 600},'v'),
  ]
}
...
Juego.capturarMovimiento = function(tecla) {
  ...
  nuevoX = movX + this.jugador.x;
  nuevoY = movY + this.jugador.y;
  // Si se puede mover hacia esa posicion hay que hacer efectivo este movimiento
  if (this.chequearColisiones(nuevoX, nuevoY)) {
    this.jugador.moverse(nuevoX,nuevoY,tecla);
  }
};
...
Juego.dibujar = function() {
  ...
  Dibujante.dibujarRectangulo('#ffe121',760,500,125,15);
...
Juego.moverEnemigos = function() {
  Juego.enemigos.forEach(function(enemigo){
    if(ZombieCaminante.prototype.isPrototypeOf(enemigo))
      enemigo.mover();
    else if(ZombieConductor.prototype.isPrototypeOf(enemigo))
      enemigo.conducir();
      else if(ZombiePerro.prototype.isPrototypeOf(enemigo))
        enemigo.correr();
  });
};
